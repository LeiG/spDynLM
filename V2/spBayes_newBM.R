...
# output
# -------
# "$n.ess"_args[1]_cond_new.txt: 
#
# "$n.ess"_args[1]_output_new.txt: matrix of parameter-wise total simulation
# effort, standard effective sample size and proposed effective sample size
#
# "$n.ess"_args[1]_mcse_new.txt: sequence of parameter-wise markov chain 
# standard error.
#
# "$n.ess"_args[1]_sd_new.txt: sequence of parameter-wise posterior standard
# deivation.
#
...
#
# "$n.ess"_args[1]_probdist_new.txt: 0/1 valued sequence used to estimate the
